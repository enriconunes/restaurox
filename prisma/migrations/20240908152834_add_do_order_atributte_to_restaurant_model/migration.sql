...
INSERT INTO "new_Restaurant" ("address", "avatarUrl", "colorThemeCode", "contactNumber", "coverUrl", "createdAt", "deliveryFee", "deliveryTimeMinutes", "doDelivery", "id", "instagramProfileName", "name", "updatedAt", "userId") SELECT "address", "avatarUrl", "colorThemeCode", "contactNumber", "coverUrl", "createdAt", "deliveryFee", "deliveryTimeMinutes", "doDelivery", "id", "instagramProfileName", "name", "updatedAt", "userId" FROM "Restaurant";
